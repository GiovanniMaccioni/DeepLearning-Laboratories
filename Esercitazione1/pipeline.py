...
def model_pipeline(config, device):
    global config_model
    if train == False:
        model, config_model = load_model("./model_weigths/"+load_model_as)
...
if __name__=="__main__":
    ...
    parser.add_argument("--train", type=bool, default=True, help='If True train the model; If False Evaluate the model')
